...
<body>
    <div class="error-container">
        ...
        <h1 class="error-title">الخدمة غير متاحة مؤقتاً</h1>
        <p class="error-message">نقوم حالياً بإجراء بعض التحسينات. سنعود قريباً!</p>
        <div class="maintenance-info">
            <i class="ti ti-clock"></i>
            <span>يرجى المحاولة مرة أخرى بعد قليل</span>
        </div>
        <br>
